    ...
    <div className={styles.container}>
      ...
      <section className={styles["section"]}>
        <div>
          <div className={styles["background-image"]}>
            <Image
              src="/static/images/uni_1.jpg" // Исправлено: убрали /public
        ...
        <div className={styles["header-container"]}>
          <Image
            src="/static/images/app_logo-removebg-preview.png" // Исправлено: убрали /public
            alt="logo"
            width={150}
            height={150}
          />
      ...
      <section className={styles["section"]}>
        <div>
          <div className={styles["background-image"]}>
            <Image
              src="/static/images/uni_2.jpg" // Исправлено: убрали /public
              alt="background image"
              fill
              style={{ objectFit: "cover" }}
            />
        ...
        <div className={styles["header-container"]}>
          <Image
            src="/static/images/robot_no_background.png" // Исправлено: убрали /public
            alt="logo"
            width={400}
            height={400}
          />
      ...
      <section className={styles["section"]}>
        <div>
          <div className={styles["background-image"]}>
            <Image
              src="/static/images/students.jpg" // Исправлено: убрали /public
              alt="background image"
              fill
              style={{ objectFit: "cover" }}
            />
