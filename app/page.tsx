    ...
    <div className={styles.container}>
      ...
      <div>
        <div className={styles["background-image"]}>
          <Image
            src="/public/static/images/uni_1.jpg"
        ...
        <div className={styles["header-container"]}>
          <Image
            src="/public/static/images/app_logo-removebg-preview.png"
            alt="logo"
            width={150}
            height={150}
          />
      ...
      <div>
        <div className={styles["background-image"]}>
          <Image
            src="/public/static/images/uni_2.jpg"
            alt="background image"
            fill
            style={{ objectFit: "cover" }}
          />
        ...
        <div className={styles["header-container"]}>
          <Image
            src="/public/static/images/robot_no_background.png"
            alt="logo"
            width={400}
            height={400}
          />
      ...
      <div>
        <div className={styles["background-image"]}>
          <Image
            src="/public/static/images/students.jpg"
            alt="background image"
            fill
            style={{ objectFit: "cover" }}
          />
